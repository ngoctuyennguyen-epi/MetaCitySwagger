...
router.get('/construct_getAll', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('construct_getAll', null, {sessionToken: global.currentUser.getSessionToken()});
...
router.get('/construct_getById', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('construct_getById', {id: parseInt(req.query.id)}, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.get('/construct_getAllConstructsInShop', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('construct_getAllConstructsInShop', null, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.get('/construct_getConstructInShopById', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('construct_getConstructInShopById', {id: parseInt(req.query.id)}, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.get('/zone_getAll', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('zone_getAll', null, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.post('/zone_create', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('zone_create', null, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.get('/zone_getZoneById', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('zone_getZoneById', {zoneId: req.query.id}, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.get('/zone_getProfile', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('zone_getProfile', {zoneId: req.query.id}, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.get('/zone_buy', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('zone_buy', {zoneId: req.query.id}, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
        return res.send({message: e.message});
    }
...
router.post('/userConstruct_updateRotation', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('userConstruct_updateRotation', {
...
router.post('/userConstruct_destroy', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('userConstruct_destroy', {
            userConstructId: req.body.userConstructId
        }, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
...
router.post('/userConstruct_collectGold', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('userConstruct_collectGold', {
            userConstructId: req.body.userConstructId
        }, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
...
router.post('/userConstruct_restoreLifeTime', async function (req, res, next) {
    try {
        const resp = await Moralis.Cloud.run('userConstruct_restoreLifeTime', {
            userConstructId: req.body.userConstructId
        }, {sessionToken: global.currentUser.getSessionToken()});
        return res.send(resp);
    } catch (e) {
